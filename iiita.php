...
<h1 class="mb-3 bread" style="color:white">About</h1>
<p class="breadcrumbs"><span class="mr-2"><a style="color:white" href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span style="color:white">About <i class="ion-ios-arrow-forward"></i></span></p>
</div>
</div>
</div>
</section>
