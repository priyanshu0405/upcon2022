        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-md-7 heading-section text-center ftco-animate text-uppercase">
                    <h2>Call For Papers <a href="files/brochure.pdf"><i style="color:black" class="fa fa-download"
            ...
            <div id="special-issue" class="row">
                <p class="col-2"><a href="https://www.springer.com/journal/42979" target="_blank"><img
                            src="images/sn.jpg" alt="" width="100%"></a></p>
                <p class="col-10" style="font-weight: 600; text-align: justify;"><mark>High-quality research papers,
                    ...
                    submit their extended versions of the paper to the topical collection (Special Issue) (1) <strong
                        style="color: orange;">Springer Nature Computer Science SI: Recent Trends in Computer
            ...
            <div class="row">
                ...
                <p class="col-10 text-justify">The accepted and presented papers will be published by Springer Series on
                    ...
                    been successfully published in Springer Book Series (DBLP Link: <a
                        href="https://dblp.org/db/conf/cvip/index">click</a>). Successfully presented papers
                ...
                <p class="col-2"><a href="https://www.springer.com/series/7899" target="_blank"><img
                            src="images/ccis.png" alt="" width="100%"></a></p>
            </div>
            <div class="row">
                <p class="col-12">
                    <b>Paper Submission:</b> The paper must not exceed 12 pages in length (including all text, figures,
                    and
                    references) as per the guidelines of Springer-CCIS Series (<a
                        href="https://www.springer.com/gp/authors-editors/conference-proceedings/conference-proceedings-guidelines">Click</a>)
                </p>
                <p class="col-12">
    ...
    technical program must describe high - quality, original research. Prospective authors are invited to submit their original research contributions in the following eleven tracks:
            ...
            <div class="row">
                ...
                <div class="row justify-content-left mb-5 ml-5 mr-5"
                    style="color: black; border: 1px solid white; border-radius: 5px; background: rgb(26,207,224);background: linear-gradient(90deg, rgba(26,207,224,1) 10%, rgba(244,244,244,1) 70%, rgba(255,184,0,0.7231267507002801) 100%); opacity: 85%;">
